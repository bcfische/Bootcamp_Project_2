/* Note: Search for !V5! for necessary changes to work with d3.v5 */
...
var TimeKnots = {
  draw: function (id, events, options) {
    var cfg = {
      ...
      addNow: false,
      //seriesColor: d3.scale.category20(), /* !V5! */
      seriesColor: d3.schemeCategory20,
      dateDimension: true
    };
    ...
    svg.selectAll("circle")
      ...
      .on("mouseover", function (d) {
        if (cfg.dateDimension) {
          //var format = d3.time.format(cfg.dateFormat); /* !V5! */
    ...
    if (cfg.showLabels != false) {
      if (cfg.dateDimension) {
        //var format = d3.time.format(cfg.labelFormat); /* !V5! */
      ...
      svg.append("text")
        .text(startString).style("font-size", "70%", "font-weight", 700)
      ...
      svg.append("text")
        .text(endString).style("font-size", "70%", "font-weight", 700)
